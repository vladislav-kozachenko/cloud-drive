...
public interface FileManagementService {
     ...
     * @return list of directories and files meta information, contained in root folder.
     ...
     * @return list of directories and files meta information, contained in the folder.
